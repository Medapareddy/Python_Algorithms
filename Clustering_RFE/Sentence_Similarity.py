tf# -*- coding: utf-8 -*-
"""
Created on Thu Apr  2 23:07:02 2020
...
print(sentence_similarity("DUTIES OF POSITION ARE VAGUE".split(), "The duties and responsibilities you have described are vague and do not establish the need for an".split(), stopwords.words('english')))
